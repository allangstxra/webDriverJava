...
public class InformacoesUsuarioTest {
    ...
    public void setUp(){
        ...
        // Clicar no link que possui o teste "Sign in"
    ...
    public void testAdicionarUmaInformacaoAdicionalDoUsuario(@Param(name="tipo")String tipo, @Param(name="contato")String contato, @Param(name="mensagem")String mensagemEsperada){
        ...
        // Identificar a popup onde está o formuláro de id addmoredata
        ...
        // No campo de name "contact" digitar o telefone "+5521983025555"
    ...
    public void removerUmContatoDeUmUsuario(){
        // Clicar no elemento pelo seu xpath //span[text()='+5551997897541']/following-sibling::a
        navegador.findElement(By.xpath("//span[text()='+5551997897541']/following-sibling::a")).click();
        ...
        String screenshotArquivo = "/Users/allanteixeira/test-report/taskit/" + Generator.dataHoraParaArquivo() + test.getMethodName() + ".png";
